 ...
 * import fr.eni.papeterie.bo.Stylo; import
 * fr.eni.papeterie.dal.jdbc.ArticleDaoJdbcImpl;
 * 
 * public class AppliTestDAL {
 * 
 * public static void main(String[] args) {
 * 
 * // Déclaration et instanciation de la DAO ArticleDaoJdbcImpl articleDAO = new
 * ArticleDaoJdbcImpl();
 * 
 ...
 * "PlumeS", "Stylo Plume Stypen", 5.5f, 20, "jaune");
 * 
 * System.out.println("Ajout des articles... "); // TODO... try {
 * articleDAO.insert(a1); System.out.println("Article ajouté  : " +
 * a1.toString()); articleDAO.insert(a2);
 * System.out.println("Article ajouté  : " + a2.toString());
 * articleDAO.insert(a3); System.out.println("Article ajouté  : " +
 * a3.toString());
 * 
 ...
 * 
 * // Sélection de tous les articles List<Article> articles =
 ...
 * ((Stylo) a1).setReference("BBNoir"); articleDAO.update(a1);
 ...
 * afficherArticles(articles); System.out.println(
 * "---------------------------------------------------------------");
 * 
 ...
 * }
 * 
 * private static void afficherArticles(List<Article> articles) { StringBuffer
 * sb = new StringBuffer(); for (Article art : articles) {
 * sb.append(art.toString()); sb.append("\n"); }
