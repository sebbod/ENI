 ...
 */
@WebServlet(urlPatterns = "/modules/module2/tp2/ServletRechercherNombre", initParams = {
		@WebInitParam(name = "BORNE_MIN", value = "10"), @WebInitParam(name = "BORNE_MAX", value = "20") })
public class ServletRechercherNombre extends HttpServlet {
	...
	public void init() throws ServletException {
		if (this.getInitParameter("BORNE_MIN") != null && !this.getInitParameter("BORNE_MIN").equals("")) {
		...
		if (this.getInitParameter("BORNE_MAX") != null && !this.getInitParameter("BORNE_MAX").equals("")) {
		...
		// On recherche entre 0 inclus et la différence max-min+1 (car valeur max
		// exclue)
