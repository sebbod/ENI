package fr.eni.javaee.module3.tp1;
...
import fr.eni.javaee.module3.tp1.bo.ActionsPossibles;

/**
 * Servlet implementation class ServletChifoumi
 */
@WebServlet("/modules/module3/tp1/ServletChifoumi")
public class ServletChifoumi extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameter("choix") != null) {
			...
			RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/modules/module3/tp1/jeu.jsp");
	...
	private void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/modules/module3/tp1/resultat.jsp");
		if (rd != null) {
			rd.forward(request, response);
		} else {
