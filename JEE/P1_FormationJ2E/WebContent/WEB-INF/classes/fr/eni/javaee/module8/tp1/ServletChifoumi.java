...
import fr.eni.javaee.module8.tp1.bo.ActionsPossibles;

/**
 * Servlet implementation class ServletChifoumi
 */
@WebServlet("/modules/module8/tp1/jouez")
public class ServletChifoumi extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameter("choix") != null) {
			...
			RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/modules/module8/tp1/jeu.jsp");
	...
	private void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		if (!StringUtils.isNumeric(request.getParameter("choix"))) {
			...
			RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/modules/module8/tp1/resultat.jsp");
			if (rd != null) {
				rd.forward(request, response);
			} else {
