package fr.eni.javaee.module9.tp1;
 ...
 */
@WebServlet("/modules/module9/tp1/ServletTestPoolConnexion")
public class ServletTestPoolConnexion extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			DataSource dataSource = (DataSource) context.lookup("java:comp/env/jdbc/module9_tp_pool_cnx");
			...
			out.println("Une erreur est survenue lors de l'utilisation de la base de données : (" + e + ")"
					+ e.getMessage());
		}
