...
<fmt:setBundle basename="fr.eni.javaee.module8.tp2.messages.messages"/>
...
<body>
	...
	<form method="POST" action="${pageContext.request.contextPath}/modules/module8/tp2/ServletChangerLangue">
		<p>
	...
	<fmt:setBundle basename="fr.eni.javaee.module8.tp2.messages.dictionnaire" var="r_langueinitiale"/>
	<fmt:setLocale value="${sessionScope.languecible}"/>
	<fmt:setBundle basename="fr.eni.javaee.module8.tp2.messages.dictionnaire" var="r_languecible"/>
