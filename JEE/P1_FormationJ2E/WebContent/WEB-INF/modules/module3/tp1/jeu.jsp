<%@page import="fr.eni.javaee.module3.tp1.bo.ActionsPossibles"%>
...
<body>
	<h1>Jouez!</h1>
	<a href="<%=request.getContextPath()%>/modules/module3/tp1/ServletChifoumi?choix=<%=ActionsPossibles.CHI%>">
		<img width="75" src="<%=request.getContextPath()%>/modules/module3/images/chi.png"/>
	</a>
	<a href="<%=request.getContextPath()%>/modules/module3/tp1/ServletChifoumi?choix=<%=ActionsPossibles.FOU%>">
		<img width="75"  src="<%=request.getContextPath()%>/modules/module3/images/fou.png"/>
	</a>
	<a href="<%=request.getContextPath()%>/modules/module3/tp1/ServletChifoumi?choix=<%=ActionsPossibles.MI%>">
		<img width="75"  src="<%=request.getContextPath()%>/modules/module3/images/mi.png"/>
	</a>
	
	<h1>Jouez!</h1>
	<form action="<%=request.getContextPath()%>/modules/module3/tp1/ServletChifoumi" method="post">
		<ul>
			<li>
